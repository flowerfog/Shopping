          ...
          <div class="panel panel-visible" id="spy2">
            <div class="panel-heading">
              ...
              <div style="float: left;margin-bottom: 5px">
                <form class="form-inline" action="${pageContext.request.contextPath}/admin/updateCommodity" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label >商品名称</label>
                    <input type="text" class="form-control" name="name" id="name" value="${commodity.name}">
                  </div>
                  ...
                  <div class="form-group">
                    <label>商品封面</label>
                    <div id="imgDiv" style="display:block; width: 300px;">
                      <img style="width: 100%" src="${pageContext.request.contextPath}${commodity.photoUrl}">
                    </div>
                  ...
                  <div class="form-group">
                    <label >商品价格</label>
                    <input type="number" class="form-control" name="price" min="0.01" id="price" value="${commodity.price}">
                  </div>
                  <div class="form-group">
                    <label >商品库存</label>
                    <input type="number" class="form-control" name="inventory" min="0" id="inventory" value="${commodity.inventory}">
                  </div>
                  <div class="form-group">
                    <label >商品折扣</label>
                    <input type="number" class="form-control" name="discount" id="discount" min="1" max="10" step="1" value="${commodity.discount * 10}">折
                  </div>
                  <div class="form-group">
                    <label>商品描述</label> <br>
