          ...
          <div class="panel panel-visible" id="spy2">
            <div class="panel-heading">
              <div class="panel-title hidden-xs">
                <span class="glyphicon glyphicon-tasks"></span>商品种类信息
              </div>
              <div style="float: left;margin-bottom: 5px">
                <form class="form-inline" action="${pageContext.request.contextPath}/admin/addCategory" method="post" enctype="multipart/form-data">
