...
<div class="container" style="overflow-x:hidden;overflow-y:auto; height: 450px">
    <br>
    <h3> 您账户的余额: ${sessionScope.user.money} <a href="#">去充值</a><br>
    您的昵称: ${sessionScope.user.username}<br>
    您的邮箱: ${sessionScope.user.email}<br>
    您的常用地址: <c:forEach items="${addressList}" var="address" varStatus="x">
            ${address.city}
            ${address.detail}<br>
            您的常用电话号: ${address.phone}
        </c:forEach><br>
        <a href="#">添加新地址</a>
