    ...
    <section id="content_wrapper">
      ...
      <!-- 主体导航栏end -->
        ...
        <div style="float: left;margin-bottom: 5px" >
          <tr>
            &nbsp;&nbsp;&nbsp;<td colspan="8" align="center"><a href="${pageContext.request.contextPath}/admin/toAdminOrderList?state=1" class="btn btn-primary">查看已完成订单</a></td>
          </tr>
        </div>

        <div style="float: left;margin-bottom: 5px" >
          <tr>
            &nbsp;&nbsp;&nbsp;<td colspan="8" align="center"><a href="${pageContext.request.contextPath}/admin/toAdminOrderList?state=0" class="btn btn-primary">查看未完成订单</a></td>
          </tr>
        </div>
          ...
          <div class="panel panel-visible" id="spy2">
            ...
            <div class="panel-body pn">
              ...
              <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                ...
                <c:forEach items="${pageInfo.list}" var="order" varStatus="x">
                  <tr>
                    <td>${x.count + (pageInfo.pageNum-1) * pageInfo.pageSize}</td>
                    <td>${order.orderUUid}</td>
                    <td>${order.createTime}</td>
                    <td>${order.state eq 0?"未完成":"已完成"}</td>
                    <td>
                      <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/admin/findOrderByOid?oid=${order.id}">订单详情</a>
                    </td>
                  </tr>
                </c:forEach>
                </tbody>
